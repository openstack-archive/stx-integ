...
# STX: Ceph takes long time to generate debuginfo package which is not used
# so disable it here.
...
%if ( 0%{?fedora} || 0%{?rhel} ) && %{without stx}
...
cp %{SOURCE11} %{_builddir}/%{name}-%{version}/src/.git_version
