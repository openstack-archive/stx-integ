...
from exception import CephMonRestfulListKeysError
from exception import CephMonRestfulJsonError
from exception import CephMonRestfulMissingUserCredentials
from exception import CephMgrDumpError
from exception import CephMgrJsonError
from exception import CephMgrMissingRestfulService
from exception import CephClientFormatNotSupported
from exception import CephClientResponseFormatNotImplemented
from exception import CephClientInvalidChoice
from exception import CephClientTypeError
from exception import CephClientValueOutOfBounds
from exception import CephClientInvalidPgid
from exception import CephClientInvalidIPAddr
from exception import CephClientInvalidOsdIdValue
from exception import CephClientNoSuchUser
from exception import CephClientIncorrectPassword
...
class CephClient(object):
    ...
    PG_DUMP_DUMPCONTENTS_VALUES = \
        [u'all', u'summary', u'sum', u'delta', u'pools',
         u'osds', u'pgs', u'pgs_brief']
    ...
    PG_DUMP_JSON_DUMPCONTENTS_VALUES = [
        u'all', u'summary', u'sum', u'pools', u'osds', u'pgs']
    ...
    PG_DUMP_STUCK_STUCKOPS_VALUES = \
        [u'inactive', u'unclean', u'stale', u'undersized',
         u'degraded']
    ...
    PG_DEBUG_DEBUGOP_VALUES = \
        [u'unfound_objects_exist', u'degraded_pgs_exist']
    ...
    OSD_DF_OUTPUT_METHOD_VALUES = [u'plain', u'tree']
    ...
    OSD_REWEIGHT_BY_UTILIZATION_NO_INCREASING_VALUES = [u'--no-increasing']
    ...
    LOG_LAST_LEVEL_VALUES = [u'debug', u'info', u'sec', u'warn', u'error']

    LOG_LAST_CHANNEL_VALUES = [u'*', u'cluster', u'audit']
    ...
    SYNC_FORCE_VALIDATE1_VALUES = [u'--yes-i-really-mean-it']

    SYNC_FORCE_VALIDATE2_VALUES = [u'--i-know-what-i-am-doing']
    ...
    HEAP_HEAPCMD_VALUES = \
        [u'dump', u'start_profiler', u'stop_profiler',
         u'release', u'stats']
    ...
    QUORUM_QUORUMCMD_VALUES = [u'enter', u'exit']
    ...
    NODE_LS__TYPE_VALUES = [u'all', u'osd', u'mon', u'mds', u'mgr']
    ...
    MON_SYNC_FORCE_VALIDATE1_VALUES = [u'--yes-i-really-mean-it']

    MON_SYNC_FORCE_VALIDATE2_VALUES = [u'--i-know-what-i-am-doing']
    ...
    MDS_SET_VAR_VALUES = \
        [u'max_mds', u'max_file_size', u'inline_data',
         u'allow_new_snaps', u'allow_multimds',
         u'allow_multimds_snaps', u'allow_dirfrags']
    ...
    MDS_NEWFS_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    FS_NEW_FORCE_VALUES = [u'--force']

    FS_NEW_SURE_VALUES = [u'--allow-dangerous-metadata-overlay']
    ...
    FS_RM_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    FS_RESET_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    FS_SET_VAR_VALUES = \
        [u'max_mds', u'max_file_size', u'allow_new_snaps',
         u'inline_data', u'cluster_down',
         u'allow_dirfrags', u'balancer',
         u'standby_count_wanted', u'session_timeout',
         u'session_autoclose', u'down', u'joinable',
         u'min_compat_client']
    ...
    FS_FLAG_SET_FLAG_NAME_VALUES = [u'enable_multiple']

    FS_FLAG_SET_CONFIRM_VALUES = [u'--yes-i-really-mean-it']
    ...
    MON_FEATURE_LS_WITH_VALUE_VALUES = [u'--with-value']
    ...
    MON_FEATURE_SET_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_TREE_STATES_VALUES = [u'up', u'down', u'in', u'out', u'destroyed']
    ...
    OSD_TREE_FROM_STATES_VALUES = [
        u'up', u'down', u'in', u'out', u'destroyed']
    ...
    OSD_CRUSH_SWAP_BUCKET_FORCE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_CRUSH_TUNABLES_PROFILE_VALUES = \
        [u'legacy', u'argonaut', u'bobtail', u'firefly',
         u'hammer', u'jewel', u'optimal', u'default']
    ...
    OSD_CRUSH_SET_TUNABLE_TUNABLE_VALUES = [u'straw_calc_version']
    ...
    OSD_CRUSH_GET_TUNABLE_TUNABLE_VALUES = [u'straw_calc_version']
    ...
    OSD_CRUSH_RULE_CREATE_SIMPLE_MODE_VALUES = [u'firstn', u'indep']
    ...
    OSD_CRUSH_TREE_SHADOW_VALUES = [u'--show-shadow']
    ...
    OSD_CRUSH_WEIGHT_SET_CREATE_MODE_VALUES = [u'flat', u'positional']
    ...
    OSD_SET_KEY_VALUES = \
        [u'full', u'pause', u'noup', u'nodown', u'noout',
         u'noin', u'nobackfill', u'norebalance',
         u'norecover', u'noscrub', u'nodeep-scrub',
         u'notieragent', u'nosnaptrim', u'sortbitwise',
         u'recovery_deletes', u'require_jewel_osds',
         u'require_kraken_osds']

    OSD_SET_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_REQUIRE_OSD_RELEASE_RELEASE_VALUES = [u'luminous', u'mimic']

    OSD_REQUIRE_OSD_RELEASE_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_FORCE_CREATE_PG_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_DESTROY_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_PURGE_NEW_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_PURGE_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_LOST_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_BLACKLIST_BLACKLISTOP_VALUES = [u'add', u'rm']
    ...
    OSD_POOL_LS_DETAIL_VALUES = [u'detail']
    ...
    OSD_POOL_CREATE_POOL_TYPE_VALUES = [u'replicated', u'erasure']
    ...
    OSD_POOL_GET_VAR_VALUES = \
        [u'size', u'min_size', u'pg_num', u'pgp_num',
         u'crush_rule', u'hashpspool', u'nodelete',
         u'nopgchange', u'nosizechange',
         u'write_fadvise_dontneed', u'noscrub',
         u'nodeep-scrub', u'hit_set_type',
         u'hit_set_period', u'hit_set_count',
         u'hit_set_fpp', u'use_gmt_hitset', u'auid',
         u'target_max_objects', u'target_max_bytes',
         u'cache_target_dirty_ratio',
         u'cache_target_dirty_high_ratio',
         u'cache_target_full_ratio',
         u'cache_min_flush_age', u'cache_min_evict_age',
         u'erasure_code_profile',
         u'min_read_recency_for_promote', u'all',
         u'min_write_recency_for_promote', u'fast_read',
         u'hit_set_grade_decay_rate',
         u'hit_set_search_last_n', u'scrub_min_interval',
         u'scrub_max_interval', u'deep_scrub_interval',
         u'recovery_priority', u'recovery_op_priority',
         u'scrub_priority', u'compression_mode',
         u'compression_algorithm',
         u'compression_required_ratio',
         u'compression_max_blob_size',
         u'compression_min_blob_size', u'csum_type',
         u'csum_min_block', u'csum_max_block',
         u'allow_ec_overwrites']
    ...
    OSD_POOL_SET_VAR_VALUES = \
        [u'size', u'min_size', u'pg_num', u'pgp_num',
         ...
         u'nodeep-scrub', u'hit_set_type',
         u'hit_set_period', u'hit_set_count',
         u'hit_set_fpp', u'use_gmt_hitset',
         u'target_max_bytes', u'target_max_objects',
         u'cache_target_dirty_ratio',
         u'cache_target_dirty_high_ratio',
         u'cache_target_full_ratio',
         u'cache_min_flush_age', u'cache_min_evict_age',
         u'auid', u'min_read_recency_for_promote',
         u'min_write_recency_for_promote', u'fast_read',
         u'hit_set_grade_decay_rate',
         u'hit_set_search_last_n', u'scrub_min_interval',
         u'scrub_max_interval', u'deep_scrub_interval',
    ...
    OSD_POOL_SET_FORCE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_POOL_SET_QUOTA_FIELD_VALUES = [u'max_objects', u'max_bytes']
    ...
    OSD_POOL_APPLICATION_ENABLE_FORCE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_POOL_APPLICATION_DISABLE_FORCE_VALUES = [u'--yes-i-really-mean-it']
    ...
    OSD_TIER_ADD_FORCE_NONEMPTY_VALUES = [u'--force-nonempty']
    ...
    OSD_TIER_CACHE_MODE_MODE_VALUES = \
        [u'none', u'writeback', u'forward', u'readonly',
         u'readforward', u'proxy', u'readproxy']

    OSD_TIER_CACHE_MODE_SURE_VALUES = [u'--yes-i-really-mean-it']
    ...
    MGR_MODULE_ENABLE_FORCE_VALUES = [u'--force']
