...
install -D -m644 %{SOURCE1} %{buildroot}/usr/share/starlingx/login.defs.cgcs
...
%post
if [ $1 -eq 1 ] ; then
	cp -f /usr/share/starlingx/login.defs.cgcs /etc/login.defs
...
/usr/share/starlingx/login.defs.cgcs
